  ...
  return (
    <section id="career" className="py-12 md:py-20">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <div className="relative bg-white border border-gray-200/70 rounded-xl p-4 md:p-8 shadow-sm hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] transition-all duration-300">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 mb-6 md:mb-10">
            ...
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-blue-50/70 flex items-center justify-center text-blue-600 text-xl md:text-2xl">
              🏢
            </div>
            ...
            <div className="space-y-3 md:space-y-4">
              {achievements.map((item) => (
                <div key={item} className="flex items-start md:items-center gap-2 md:gap-3">
                  <span className="text-blue-600 mt-[2px] md:mt-0">✔</span>
