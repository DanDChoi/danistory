  ...
  return (
    <section id="about" className="py-16 md:py-20">
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        {/* Title */}
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 md:mb-12">About Me</h2>
        ...
        <div className="bg-white border border-gray-200/70 rounded-xl p-5 md:p-9 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <p className="text-[14px] md:text-base text-gray-600 leading-relaxed mb-3 md:mb-4">
            ...
            <br />
            상품 노출, 주문, 결제까지 사용자 여정 전반을 안정적으로 관리하며, <br className="hidden md:block" />더 나은 경험을 설계하는 데 집중했습니다.
          </p>

          <p className="text-[14px] md:text-base text-gray-600 leading-relaxed mb-3 md:mb-4">
            단순 기능 구현을 넘어서, 현업의 맥락을 이해하고 흐름에 맞는 개발을 지향해왔습니다.<br />특히, <span className="font-semibold text-gray-900">속도 개선·데이터 최적화·운영 안정성</span> 등<br />반복적이지만 중요한 영역에서 지속적인 개선을 만들어낸 경험이 많습니다.
          </p>
