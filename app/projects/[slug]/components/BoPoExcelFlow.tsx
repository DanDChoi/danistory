...
export default function BoPoExcelFlow() {
  return (
    <svg width="100%" viewBox="0 0 680 460" className="w-full">
      ...
      <text x="95"  y="36" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">담당자</text>
      ...
      <text x="258" y="36" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">Spring 서버</text>
      ...
      <text x="172" y="84" textAnchor="middle" fontSize="11" fill="#5F5E5A">엑셀 파일 업로드</text>
      ...
      <text x="338" y="114" textAnchor="middle" fontSize="11" fill="#5F5E5A">Workbook 파싱 요청</text>

      <rect x="346" y="136" width="160" height="52" rx="6" fill="#FAEEDA" stroke="#BA7517" strokeWidth="0.5"/>
      <text x="426" y="152" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#633806">Row 순회</text>
      <text x="426" y="170" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#854F0B">Cell 타입 변환 · 매핑</text>
      <text x="426" y="184" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#854F0B">빈 행 / 헤더 스킵</text>

      <line x1="418" y1="192" x2="268" y2="202" stroke="#BA7517" strokeWidth="1.5" strokeDasharray="5 3" markerEnd="url(#arr-bp)"/>
      <text x="343" y="194" textAnchor="middle" fontSize="11" fill="#5F5E5A">파싱된 데이터 반환</text>
      ...
      <text x="258" y="226" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#2C2C2A">유효성 검증</text>
      <text x="258" y="244" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#5F5E5A">필수값 · 형식 · 중복 체크</text>
      <text x="258" y="258" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#5F5E5A">오류 행 수집</text>
      ...
      <text x="95"  y="282" textAnchor="middle" dominantBaseline="central" fontSize="11" fontWeight="500" fill="#A32D2D">오류 피드백</text>
      <text x="95"  y="298" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#791F1F">오류 행 목록 반환</text>
      <text x="142" y="252" fontSize="10" fill="#E24B4A">검증 실패</text>
      ...
      <text x="274" y="302" fontSize="10" fill="#888780">검증 성공</text>
      ...
      <text x="426" y="322" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#0C447C">변경 내역 로깅</text>
      <text x="426" y="340" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#185FA5">변경 전·후 값 기록</text>
      <text x="426" y="354" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#185FA5">처리 일시 저장</text>
      ...
      <text x="424" y="370" textAnchor="middle" fontSize="11" fill="#5F5E5A">처리 결과 반환</text>
      ...
      <text x="95"  y="418" textAnchor="middle" dominantBaseline="central" fontSize="11" fontWeight="500" fill="#085041">처리 완료</text>
      <text x="95"  y="434" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">성공 건수 표시</text>
    </svg>
  );
}
