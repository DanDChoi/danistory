...
export default function WizpayPlatformFlow() {
  return (
    <svg width="100%" viewBox="0 0 680 420" className="w-full">
      ...
      <text x="340" y="42" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#2C2C2A">주문서 진입</text>
      ...
      <text x="340" y="124" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">환경 감지</text>
      ...
      <text x="90" y="124" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">PC 웹</text>
      <text x="90" y="142" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#534AB7">click 이벤트</text>

      {/* ── Mobile 박스 ── */}
      <rect x="260" y="210" width="160" height="44" rx="8" fill="#EEEDFE" stroke="#7F77DD" strokeWidth="0.5"/>
      <text x="340" y="226" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">모바일 웹</text>
      <text x="340" y="244" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#534AB7">touch 이벤트</text>

      {/* ── App 박스 ── */}
      <rect x="520" y="108" width="140" height="44" rx="8" fill="#EEEDFE" stroke="#7F77DD" strokeWidth="0.5"/>
      <text x="590" y="124" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="500" fill="#3C3489">앱 WebView</text>
      <text x="590" y="142" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#534AB7">앱 Bridge 이벤트</text>
      ...
      <text x="90"  y="297" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#085041">동적 UI 구성</text>
      <text x="90"  y="315" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">무이자 / 할부 옵션</text>
      <text x="90"  y="330" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">select box 렌더링</text>

      <rect x="260" y="280" width="160" height="56" rx="8" fill="#E1F5EE" stroke="#1D9E75" strokeWidth="0.5"/>
      <text x="340" y="297" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#085041">동적 UI 구성</text>
      <text x="340" y="315" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">무이자 / 할부 옵션</text>
      <text x="340" y="330" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">select box 렌더링</text>

      <rect x="520" y="280" width="140" height="56" rx="8" fill="#E1F5EE" stroke="#1D9E75" strokeWidth="0.5"/>
      <text x="590" y="297" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#085041">동적 UI 구성</text>
      <text x="590" y="315" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">무이자 / 할부 옵션</text>
      <text x="590" y="330" textAnchor="middle" dominantBaseline="central" fontSize="11" fill="#0F6E56">select box 렌더링</text>
      ...
      <text x="340" y="395" textAnchor="middle" dominantBaseline="central" fontSize="12" fontWeight="500" fill="#085041">동일한 결제 UX 제공</text>
    </svg>
  );
}
